...
import (
	_ "feicoin/x/feicoin/module"
	feicoinmoduletypes "feicoin/x/feicoin/types"
	"time"
...
var (
	...
	appConfig = appconfig.Compose(&appv1alpha1.Config{
		Modules: []*appv1alpha1.ModuleConfig{
			...
			{
				Name:   feicoinmoduletypes.ModuleName,
				Config: appconfig.WrapAny(&feicoinmoduletypes.Module{}),
			},
